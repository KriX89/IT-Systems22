        ...
        <div class="row">
               <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <div class="col-md-8" style="text-align:center">
                    ...
                    <tr>
                        <td><asp:Label ID="Label1" runat="server" Text="Type Name: " /></td><td><asp:TextBox ID="TextBox1" runat="server" ForeColor="Black" /></td>
                    </tr>
                    <tr>
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Add Type" ForeColor="Black" OnClientClick="return confirm('Are you sure you want to add?')" OnClick="Button1_Click" />
